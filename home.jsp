...
<table cellpadding="0" cellspacing="0" id="content1"><tr align="justify">
 <td class="con" valign="top">
     <div id="heade1"><h1>Results</h1></div>
        <p>This is  Hindavi Business bank which is under business and finance category for your website design. Freedesignertemplates.com is a free collection of site templates with HTML layouts which are frequently updated.<br><br>
    ...
    <td class="con" valign="top">
     <div id="heade2"><h1>Opportunities</h1></div>
        <p> These Hindavi Business bank would be idle for building a successful online businesses.  Download the required HTML template, install it and edit the existing content with your original text.<br><br>
 ...
 <td width="299" valign="top" style="border-right:#666666 1px dotted;">
    ...
    <td width="299" valign="top">
     <div id="welcome" style="border-right:#666666 1px dotted;"><h1>Welcome</h1><br>
         <center><img src="globe_10.gif" alt="business" width="196" height="106"></center><br>
    ...
    <td width="299" valign="top">
      <div id="news"><h1>News &amp; Events</h1><br>
       <div class="img"><img src="globe_12.gif" alt="Business"></div>
        <h2>JAN. 01, 2022.</h2>
        <p>Get your dream web design at no cost, no extra manpower for your professional website.</p><br>
        <div class="img"><img src="globe_16.gif" alt="Business"></div>
        <h2>JAN. 01, 2022.</h2>
